...
class JourneyMatchResponseTest extends TestCase
{
    public function testParse()
    {
        ...
        self::assertEquals('2023-04-03T12:37:00+00:00', $journeys[0]->stopovers[0]->departure->format(DATE_ATOM));
        self::assertEquals('2023-04-03T14:53:00+00:00', $journeys[0]->stopovers[1]->arrival->format(DATE_ATOM));
        ...
        self::assertEquals('2023-01-08T15:06:00+00:00', $journeys[5]->stopovers[0]->departure->format(DATE_ATOM));
        self::assertEquals('2023-01-08T21:54:00+00:00', $journeys[5]->stopovers[1]->arrival->format(DATE_ATOM));
